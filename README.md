...
To optimize the digitalgifts application for production, run:
...
[Service Discovery and Configuration with Consul]: http://www.jhipster.tech/documentation-archive/v4.14.2/microservices-architecture/#consul
